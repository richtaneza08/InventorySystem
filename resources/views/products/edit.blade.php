<!-- Modal -->
<div class="modal fade" id="edit{{ $product->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="categories_id" placeholder="Please Select Categories">
                            ...
                            @foreach ($categories as $categoriesId => $categoriesName)
                                <option value="{{ $categoriesId }}" {{ old('categories_id', $product->categories_id) == $categoriesId ? 'selected' : '' }}>
                                    {{ $categoriesName }}
                                </option>
                            @endforeach
                        </select>
